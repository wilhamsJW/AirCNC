...
module.exports = {
    ...
    async index(req, res) {            //index foi uma requisição criada no insominia, lá eu coloquei um nome e valor, q irá levar o user a rota da escolha da informação q ele escolheu
        ...
        const spots = await Spot.find({ techs: tech }); //techs é o nosso campo no db, tech é o valor acima q virá com um valor dentro, esse valor dentro dele é a escolha da infirmação que o usuário escolheu
